...
#include <stdio.h>
#include <string.h>
#include "fix_nve_sphere_sintering.h"
#include "atom.h"
#include "atom_vec.h"
#include "update.h"
#include "respa.h"
...
FixNVESphereSintering::FixNVESphereSintering(LAMMPS *lmp, int narg, char **arg) :
  FixNVE(lmp, narg, arg),
  useAM_(false),
  CAddRhoFluid_(0.0),
...
void FixNVESphereSintering::init()
{
  FixNVE::init();
...
void FixNVESphereSintering::initial_integrate(int vflag)
{
...
void FixNVESphereSintering::final_integrate()
{
