...
FixStyle(nve/sphere/sintering,FixNVESphereSintering)

#else

#ifndef LMP_FIX_NVE_SPHERE_SINTERING_H
#define LMP_FIX_NVE_SPHERE_SINTERING_H

#include "fix_nve.h"

namespace LAMMPS_NS {

class FixNVESphereSintering : public FixNVE {
 public:
  FixNVESphereSintering(class LAMMPS *, int, char **);
  virtual ~FixNVESphereSintering() {}
  void init();
